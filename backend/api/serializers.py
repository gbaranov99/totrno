...
class UserDetailsSerializer(UserDetailsSerializer):
    ...
    class Meta(UserDetailsSerializer.Meta):
        fields = UserDetailsSerializer.Meta.fields + ('timer_choice', 'pomodoro_duration', 'pomodoro_small_break_count', 'pomodoro_small_break_duration', 'pomodoro_big_break_duration',)
